        ...
        <div className="cards-grid">
          ...
          <article className="card project-card">
            <div className="project-card-img-wrap">
              <img src="images/shell-fuel.jpg" alt="Sustainable fuel blending graphs" />
            </div>
          ...
          <article className="card project-card">
            <div className="project-card-img-wrap">
              <img src="images/imc-trading.jpg" alt="Trading candlestick chart" />
            </div>
          ...
          <article className="card project-card">
            <div className="project-card-img-wrap">
              <img src="images/koronakiller-game.jpg" alt="KoronaKiller 2D game screenshot" />
            </div>
